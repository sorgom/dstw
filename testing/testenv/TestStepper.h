//! @file
//! @brief      tracing of last test steps in case of test failure
//!
//! @author     SOM, Manfred Sorgo, manfred.sorgo.ext@siemens.com
//!
//! @reviewer   TODO: assign reviewer
//!
//! @copyright (c) Siemens Mobility AG 2022 all rights reserved confidential
//!
//! Change History
//! @date 2020-03-10 SOM: creation of file

#ifndef TESTLIB_TESTSTEPPER_H
#define TESTLIB_TESTSTEPPER_H
...
//! assign precondition
#define PRECONDITION() testlib::TestStepper::precondition(__FILE__, __LINE__, __STEPPER_FUNCTION__);
#define SETUP() PRECONDITION()

//! assign a step
#define STEP(n) testlib::TestStepper::step(n, __FILE__, __LINE__, __STEPPER_FUNCTION__);
...
#define BEGINSTEPS() testlib::TestStepper::beginSteps(__FILE__, __LINE__, __STEPPER_FUNCTION__);

//! leave set of steps
#define ENDSTEPS() testlib::TestStepper::endSteps();
