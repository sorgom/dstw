...
namespace test
{
    ...
    TEST(DT_03, T01)
    {
        ...
        {
            LSTEP(n)
            const ComAddr& name = genComAddr(CAPTSW - n, "TSW");
        ...
        {
            LSTEP(n)
            const ComAddr& name = genComAddr(CAPSIG - n, "SIG");
        ...
        {
            LSTEP(n)
            const ComAddr& name = genComAddr(CAPLCR - n, "LCR");
        ...
        {
            LSTEP(n)
            const ComAddr& name = genComAddr(CAPSEG - n, "SEG");
