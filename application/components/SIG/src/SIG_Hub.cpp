...
void SIG_Hub::toFld(const size_t id, const UINT8 param1, const UINT8 param2) const
{
    IL::getDispatcher().dispatch(id, ComTeleFld(param1, param2));
}

void SIG_Hub::toGui(const size_t id, const UINT8 param1, const UINT8 param2) const
{
