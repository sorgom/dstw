...
set covfile=%makeDir%\moduletests.cov
...
echo - moduletests
call msbuild /t:moduletests /p:Configuration=ci %vsSolution% >> %buildLog% 2>&1

call cov01 -q --off

@REM if not exist %covfile% (
@REM     echo %covfile% not found
@REM     exit /b 1
@REM )
