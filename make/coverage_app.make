...
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -g -std=c++2a -pedantic-errors -Werror -Wall -fprofile-arcs -ftest-coverage
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -g -std=c++2a -pedantic-errors -Werror -Wall -fprofile-arcs -ftest-coverage
