...
ifeq ($(config),ci)
OBJDIR = obj/gcc/run_app/ci
INCLUDES += -I../specification -I../application/components

else ifeq ($(config),qnd)
OBJDIR = obj/gcc/run_app/qnd
INCLUDES += -I../specification -I../application/components -I../devel
