...
LIBS += lib/librun_app.a -lcppu_test
LDDEPS += lib/librun_app.a
...
INCLUDES += -I../specification -I../application/components -I../testing/testenv -I../cpputest/include -I../CppUTestSteps/TestSteps/include

else ifeq ($(config),qnd)
OBJDIR = obj/gcc/run_tests/qnd
INCLUDES += -I../devel -I../specification -I../application/components -I../testing/testenv -I../cpputest/include -I../CppUTestSteps/TestSteps/include
